...
This is a simple FAQ block, but it also generates the FAQ schema markup. More information on the schema and why it is useful can be found on Google's structured data documentation: https://developers.google.com/search/docs/appearance/structured-data/faqpage.
